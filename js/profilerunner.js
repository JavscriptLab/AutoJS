var ajskeep=function(key,value,callback)
{
...
var ajspeek = function (key, callback) {
...
var ajskoop = function (key, callback) {
...
(function ($) {
  ...
  $("body").append('<div class="autojsicon">A</div><div class="autojs ">' +
    ...
    '<input type="text" id="runnerprofilename" placeholder="Profile name"/> ' +
    '<button type="button" id="runnerprofilestart" >Start</button> ' +
    '<button type="button" id="runnerprofilestop" >Stop</button> ' +
    '</div>');
