...
valid=true;
    ...
    ls("jquery.js", "",
        function()
        {
            ...
            ls("profilerunner.js", "");
            ls("applyjob.js", "applicant|hiring|hire|taleo|position|candidate|staff|portal|work|empl|software|job|career|apply|vacancies|vacancy|application|sollicitatie|profile|experince|sign&up|register");            
